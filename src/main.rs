...
fn run_day_part(day : &u8, part : &u8) {
    match day {
        ...
        7 => match part {
            1 => day_07_part_1::main(),
            2 => day_07_part_2::main(),
            _ => return,
        },
        8 => match part {
            1 => day_08_part_1::main(),
            2 => day_08_part_2::main(),
            _ => return,
        },
        9 => match part {
            1 => day_09_part_1::main(),
            2 => day_09_part_2::main(),
            _ => return,
        },
        10 => match part {
            1 => day_10_part_1::main(),
            2 => day_10_part_2::main(),
            _ => return,
        },
